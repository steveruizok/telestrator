...
/* harmony import */ var electron_updater__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! electron-updater */ "electron-updater");
/* harmony import */ var electron_updater__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(electron_updater__WEBPACK_IMPORTED_MODULE_4__);
...
(async () => {
  ...
  _babel_runtime_corejs3_core_js_stable_set_interval__WEBPACK_IMPORTED_MODULE_0___default()(() => {
    electron_updater__WEBPACK_IMPORTED_MODULE_4__["autoUpdater"].checkForUpdatesAndNotify();
  }, 10 * 60 * 1000);

  electron_updater__WEBPACK_IMPORTED_MODULE_4__["autoUpdater"].on("update-downloaded", (event, releaseNotes, releaseName) => {
    const dialogOpts = {
      type: "info",
    ...
    dialog.showMessageBox(dialogOpts).then(returnValue => {
      if (returnValue.response === 0) electron_updater__WEBPACK_IMPORTED_MODULE_4__["autoUpdater"].quitAndInstall();
    });
  });
  electron_updater__WEBPACK_IMPORTED_MODULE_4__["autoUpdater"].on("error", message => {
  ...
  electron__WEBPACK_IMPORTED_MODULE_1__["app"].whenReady().then(() => {
    // Check for updates.
    electron_updater__WEBPACK_IMPORTED_MODULE_4__["autoUpdater"].checkForUpdatesAndNotify(); // Register a 'CommandOrControl+Z' shortcut listener.
